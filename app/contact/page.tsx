...
const ContactPage: React.FC<ContactPageProps> = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-white p-6">
      ...
      >
        We are here to assist you with any inquiries regarding our luxurious cosmetics line. Please fill out the form below, and our customer service team will get back to you shortly.
      </motion.p>
      ...
      <div className="mt-10 text-center">
        ...
        <p className="text-lg text-gray-700">123 Luxury Lane, Suite 100</p>
        <p className="text-lg text-gray-700">Cosmetics City, CA 90210</p>

        <h2 className="text-2xl font-bold text-orange-600 mt-8 mb-4">Business Hours</h2>
